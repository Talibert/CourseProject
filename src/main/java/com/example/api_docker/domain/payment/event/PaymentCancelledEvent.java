...
public record PaymentCancelledEvent(UUID eventId, LocalDateTime occurredAt, PaymentId paymentId, EnrollmentId enrollmentId) implements DomainEvent {

    public PaymentCancelledEvent(PaymentId paymentId, EnrollmentId enrollmentId) {
