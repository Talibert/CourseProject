...
public record PaymentCreatedEvent(UUID eventId, LocalDateTime occurredAt, PaymentId paymentId, EnrollmentId enrollmentId) implements DomainEvent {

    public PaymentCreatedEvent(PaymentId paymentId, EnrollmentId enrollmentId) {
