...
public record PaymentFailedEvent(UUID eventId, LocalDateTime occurredAt, PaymentId paymentId, EnrollmentId enrollmentId) implements DomainEvent {

    public PaymentFailedEvent(PaymentId paymentId, EnrollmentId enrollmentId) {
