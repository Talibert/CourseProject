...
public record EnrollmentCompletedEvent(UUID eventId, LocalDateTime occurredAt,
        EnrollmentId enrollmentId, StudentId studentId, CourseId courseId) implements DomainEvent {

    public EnrollmentCompletedEvent(EnrollmentId enrollmentId, StudentId studentId, CourseId courseId) {
